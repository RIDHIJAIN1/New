...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const role = response.user.isAdmin ? "admin" : "user";
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                />
                <PhoneIcon className="absolute top-1/2 transform -translate-y-1/2 right-3 text-gray-500" />
              </div>
            </div>
            {/* WhatsApp No */}
            <div>
              <label className="block text-sm mb-1">WhatsApp No</label>
              <div className="relative">
                <input
                  type="text"
                  name="whatsappNo"
                  ...
                  onChange={handleChange}
                />
                <ChatIcon className="absolute top-1/2 transform -translate-y-1/2 right-3 text-gray-500" />
              </div>
            </div>
            {/* Email Address */}
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                />
                <LocationCityIcon className="absolute top-1/2 transform -translate-y-1/2 right-3 text-gray-500" />
              </div>
            </div>
            {/* Referral Code */}
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                />
                <CodeIcon className="absolute top-1/2 transform -translate-y-1/2 right-3 text-gray-500" />
              </div>
            </div>
            {/* Password */}
            <div>
